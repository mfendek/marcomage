...
case 'Players':	
	...
	$params['players']['name_filter'] = $name_filter = (isset($_POST['name_filter'])) ? $_POST['name_filter'] : '';
	...
	$list = $playerdb->ListPlayers($filter, $status_filter, $name_filter, $condition, $order, $current_page);
