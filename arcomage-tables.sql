...
CREATE TABLE `settings` (
  ...
  `Online` char(3) collate utf8_unicode_ci NOT NULL default 'yes',
  `Offline` char(3) collate utf8_unicode_ci NOT NULL default 'yes',
  `Inactive` char(3) collate utf8_unicode_ci NOT NULL default 'no',
  `Dead` char(3) collate utf8_unicode_ci NOT NULL default 'no',
