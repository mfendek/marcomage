...
<?php
	...
	class CSetting
	{
		...
		{
			return array('FriendlyFlag', 'BlindFlag', 'Minimize', 'Images', 'Nationality', 'Chatorder', 'Avatargame', 'Avatarlist', 'Correction', 'OldCardLook', 'Reports', 'Forum_notification', 'Concepts_notification', 'GamesDetails', 'RandomDeck');
		}
