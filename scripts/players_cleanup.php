<?php
	...
	- deletes dead users and their related data
	...
	*/
	...
	$result = $db->Query('SELECT `Username` FROM `logins` WHERE (UNIX_TIMESTAMP(`Last Query`) < UNIX_TIMESTAMP() - 60*60*24*7*3) LIMIT 0 , 50');
