...
class Result
{
     ...
     * @var bool
     */
    protected $controllerProcessing = false;
     ...
     * @return bool
     */
    public function controllerProcessing()
    {
        return $this->controllerProcessing;
    }
     ...
     * @return $this
     */
    public function setCookie($key, $value, $lifespan)
    {
        $this->cookies[$key] = [$value, $lifespan];
        return $this;
    }
     ...
     * @return $this
     */
    public function enableControllerProcessing()
    {
        $this->controllerProcessing = true;
        return $this;
    }
