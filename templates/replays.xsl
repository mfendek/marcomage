        ...
        <div class="responsive-table responsive-table--centered table-md skin-text top-level">
          ...
          <xsl:for-each select="$param/list/*">
            ...
            <div class="row table-row table-row--details">
                ...
                <p>
                  ...
                  <xsl:choose>
                    <xsl:when test="is_deleted = 'no'">
                      <a class="hidden-link details-link"
                         href="{am:makeUrl('Replays_details', 'CurrentReplay', game_id, 'PlayerView', 1, 'Turn', 1)}">
              ...
              <div class="col-md-1">
                <p>
                  <xsl:copy-of select="am:date(started_at, $param/timezone)"/>
                </p>
              </div>
              <div class="col-md-1">
                <p>
                  <xsl:copy-of select="am:date(finished_at, $param/timezone)"/>
                </p>
              </div>
              <div class="col-md-2">
                <p>
      ...
      <div class="row">
        <div class="col-sm-7">
          ...
          <div class="filters filters--plain">
            ...
            <xsl:choose>
              <xsl:when test="$current &gt; 1">
                <a class="button button-icon"
                   href="{am:makeUrl('Replays_details', 'CurrentReplay', $param/current_replay, 'PlayerView', $param/player_view, 'Turn', am:max($current - 1, 1))}">
            ...
            <xsl:choose>
              <xsl:when test="$current &gt; 1">
                <a class="button button-icon"
                   href="{am:makeUrl('Replays_details', 'CurrentReplay', $param/current_replay, 'PlayerView', $param/player_view, 'Turn', 1)}">
            ...
            <xsl:for-each select="str:split(am:numbers(am:max($current - 5, 1), am:min($current + 5, $turns)), ',')">
              <xsl:choose>
                <xsl:when test="$current != .">
                  <a class="button button-icon"
                     href="{am:makeUrl('Replays_details', 'CurrentReplay', $param/current_replay, 'PlayerView', $param/player_view, 'Turn', text())}">
                    <xsl:value-of select="text()"/>
                  </a>
                </xsl:when>
                <xsl:otherwise>
            ...
            <xsl:choose>
              <xsl:when test="$current &lt; $turns">
                <a class="button button-icon"
                   href="{am:makeUrl('Replays_details', 'CurrentReplay', $param/current_replay, 'PlayerView', $param/player_view, 'Turn', $turns)}">
            ...
            <xsl:choose>
              <xsl:when test="$current &lt; $turns">
                <a id="next" class="button button-icon"
                   href="{am:makeUrl('Replays_details', 'CurrentReplay', $param/current_replay, 'PlayerView', $param/player_view, 'Turn', am:min($current + 1, $turns))}">
        ...
        <div class="col-sm-5">
          <div class="filters filters--plain">
            ...
            <a class="button button-icon"
               href="{am:makeUrl('Replays_details', 'CurrentReplay', $param/current_replay, 'PlayerView', $view, 'Turn', $current)}"
      ...
      <div class="game__board">
        ...
        <div class="row">
          <div>
            ...
            <p class="info-label game__state-info"><xsl:value-of select="$param/current_player"/>'s turn
            </p>
          </div>
        </div>
      ...
      <div class="row">
        ...
        <div class="filters">
          ...
          <xsl:choose>
            <xsl:when test="$current &gt; 1">
              <a class="button button-icon"
                 href="{am:makeUrl('Replays_history', 'CurrentReplay', $param/current_replay, 'Turn', am:max($current - 1, 1))}">
                <span class="glyphicon glyphicon-chevron-left"/>
              </a>
            </xsl:when>
            <xsl:otherwise>
          ...
          <xsl:choose>
            <xsl:when test="$current &gt; 1">
              <a class="button button-icon"
                 href="{am:makeUrl('Replays_history', 'CurrentReplay', $param/current_replay, 'Turn', 1)}">
                <span class="glyphicon glyphicon-step-backward"/>
              </a>
            </xsl:when>
            <xsl:otherwise>
          ...
          <xsl:for-each select="str:split(am:numbers(am:max($current - 5, 1), am:min($current + 5, $turns)), ',')">
            <xsl:choose>
              <xsl:when test="$current != .">
                <a class="button button-icon"
                   href="{am:makeUrl('Replays_history', 'CurrentReplay', $param/current_replay, 'Turn', text())}">
                  <xsl:value-of select="text()"/>
                </a>
              </xsl:when>
              <xsl:otherwise>
          ...
          <xsl:choose>
            <xsl:when test="$current &lt; $turns">
              <a class="button button-icon"
                 href="{am:makeUrl('Replays_history', 'CurrentReplay', $param/current_replay, 'Turn', $turns)}">
                <span class="glyphicon glyphicon-step-forward"/>
              </a>
            </xsl:when>
            <xsl:otherwise>
          ...
          <xsl:choose>
            <xsl:when test="$current &lt; $turns">
              <a class="button"
                 href="{am:makeUrl('Replays_history', 'CurrentReplay', $param/current_replay, 'Turn', am:min($current + 1, $turns))}">
                <span class="glyphicon glyphicon-chevron-right"/>
              </a>
            </xsl:when>
            <xsl:otherwise>
