                                  ...
                                  <xsl:for-each select="exsl:node-set($parts)/*">
                                    <li>
                                      <a class="button button-icon"
                                         href="{am:makeUrl('Novels', 'novel', $param/novel, 'chapter', $param/chapter, 'part', @name, 'page', 1)}">
              ...
              <xsl:choose>
                <xsl:when test="$content">
                    ...
                    <div class="side-navbar__previous-page">
                      <xsl:choose>
                        <xsl:when test="$page &gt; 1">
                          <a class="button button-icon"
                             href="{am:makeUrl('Novels', 'novel', $param/novel, 'chapter', $param/chapter, 'part', $param/part, 'page', am:max($page - 1, 1))}">
                    ...
                    <div class="side-navbar__next-page">
                      <xsl:choose>
                        <xsl:when test="$page &lt; $pages">
                          <a class="button button-icon"
                             href="{am:makeUrl('Novels', 'novel', $param/novel, 'chapter', $param/chapter, 'part', $param/part, 'page', am:min($page + 1, $pages))}">
                  ...
                  <div class="side-navbar__pagination">
                    <xsl:copy-of select="$navigationBar"/>
                    <a class="button button-icon"
                       href="{am:makeUrl('Novels', 'novel', $param/novel, 'chapter', $param/chapter, 'part', $param/part, 'page', $page)}">
                ...
                <xsl:otherwise>
                  ...
                  <p>
                    All novels are written by our external associate <a href="mailto:thomasteekanne@gmail.com">Lukáš
                    Čajági</a>, and therefore all novels
                    are exclusive property of the author.
                  </p>
                  <br/>
                  <p>This novel will probably be a trilogy, the name is not known yet. The author provided us with
                  ...
                  <p>
                    <i>Trasymachos, former member of the Alchemist's Guild, outlawed fugitive</i>
                  </p>
                  <br/>
                  <p>For feedback regarding novels please use the appropriate thread in the forum's 'Novels' section.
                  </p>
                  <br/>
