      ...
      <div class="col-md-6">
        ...
        <div class="skin-text top-level settings-panel">
          ...
          <div class="settings-panel__picture">
            ...
            <h5>
              <xsl:value-of select="$settings/sign"/>
            </h5>
          </div>
          ...
          <p>
            ...
            <img class="icon-image" width="18" height="12" src="img/flags/{am:fileName($settings/country)}.gif"
                 alt="country flag" title="{$settings/country}"/>
          </p>
          ...
          <p>
            <span class="settings-panel__wallet">
              <xsl:value-of select="$param/gold"/> gold available
            </span>
