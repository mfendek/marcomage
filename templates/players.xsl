...
<xsl:stylesheet version="1.0"
            ...
            <div class="responsive-table table-sm skin-text">
                ...
                <div class="row">
                    ...
                    <xsl:for-each select="exsl:node-set($columns)/*">
                        <div class="col-sm-{@size}"><p><xsl:value-of select="@text"/></p></div>
                    </xsl:for-each>
                </div>
    ...
    <xsl:template match="section[. = 'Players_details']">
        ...
        <div id="details">
            <div class="skin-text">
                <h3><xsl:value-of select="$param/player_name"/>'s details</h3>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-6">
                                <p class="detail_value" style="color: {$genderColor}">
                        ...
                        <div class="row">
                            <div class="col-xs-6"><p>Date of birth (dd-mm-yyyy)</p></div>
                            <div class="col-xs-6">
                ...
                <div class="detail_value hobbies">
    ...
    <xsl:template match="section[. = 'Players_achievements']">
        ...
        <div id="achievements" class="skin-label top-level">
            <h3>
            ...
            <div class="row">
                ...
                <xsl:for-each select="$param/data/*">
                    <div class="col-md-4">
                        <p class="achievement-heading">Tier <xsl:value-of select="position()"/></p>
