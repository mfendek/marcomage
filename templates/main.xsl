                      ...
                      <div class="modal-dialog vertical-align-center">
                        <div class="modal-content">
                          <div class="modal-header">
                            <button name="close-modal" type="button" class="close" data-dismiss="modal">
                              &#10006;
                            </button>
                        ...
                        <div class="modal-dialog vertical-align-center">
                          <div class="modal-content">
                            <div class="modal-header">
                              ...
                              <p class="modal-title">
                                Congratulations, you have reached level <xsl:value-of select="$levelup_data/@id"/> !
                              </p>
                            </div>
                            <div class="modal-body">
                              <p>
                                <xsl:if test="$levelup_data/@section != ''">
                                  <p>
                                    <b><xsl:value-of select="$levelup_data/@section"/></b> section unlocked.
                                  </p>
                                  <input type="hidden" name="unlock_section" value="{$levelup_data/@section}"/>
                                </xsl:if>
                                <xsl:if test="$levelup_data/@desc != ''">
                                  <p>
                                    <xsl:value-of select="$levelup_data/@desc"/>
                                  </p>
                                </xsl:if>
            ...
            <div class="skin-text">
              <div>
                <a class="hidden-link" href="{am:makeUrl('Players_achievements', 'Profile', $param/player_name)}">
                  <img class="icon-image" height="16" width="16" src="img/achievement.png" alt="{$param/player_name}'s achievements" title="{$param/player_name}'s achievements"/>
                </a>
