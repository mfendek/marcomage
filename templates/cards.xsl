    ...
    <div class="responsive-table responsive-table--centered table-md skin-text top-level">
      ...
      <xsl:for-each select="$param/card_list/*">
        <div class="row">
          ...
          <div class="col-md-1">
            <p>
              <xsl:value-of select="am:formatDate(created)"/>
            </p>
          </div>
          <div class="col-md-1">
            <p>
              <xsl:value-of select="am:formatDate(modified)"/>
            </p>
          </div>
        </div>
      </xsl:for-each>
  ...
  <xsl:template match="section[. = 'Cards_details']">
    ...
    <div class="skin-text details-form">
      ...
      <div class="row">
        ...
        <div class="col-xs-6">
          <xsl:value-of select="$param/data/modes"/>
        </div>
      </div>
      <div class="row">
        <div class="col-xs-6">Level</div>
        <div class="col-xs-6">
          <xsl:value-of select="$param/data/level"/>
        </div>
      </div>
      <div class="row">
        <div class="col-xs-6">Created</div>
        <div class="col-xs-6">
          <xsl:value-of select="am:formatDate($param/data/created)"/>
        </div>
      </div>
      <div class="row">
        <div class="col-xs-6">Modified</div>
        <div class="col-xs-6">
          <xsl:value-of select="am:formatDate($param/data/modified)"/>
        </div>
      </div>
      <div class="row">
